<?php
	...
	try{
		...
		$user->xoaYKienPheDuyet($_POST['id']);
		echo json_encode(new AJAXEditResult(1, ['Xóa thành công ý kiến phê duyệt']), JSON_UNESCAPED_UNICODE);
	}catch(Exception $e){
