...
--
-- Host: localhost
-- Generation Time: Oct 15, 2018 at 07:21 PM
...
INSERT INTO `congvanden` (`id`, `soden`, `kyhieu`, `thoigianden`, `ngayvanban`, `madonvibanhanh`, `trichyeu`, `nguoiky`, `maloaivanban`, `thoihangiaiquyet`, `tentaptin`, `trangthai`, `idnguoinhap`, `thoigianthem`) VALUES
(1, 1, '35/STTTT', '2016-01-13 00:00:00', '2016-01-12', 'DV_STTTT', 'VV chuyển văn bản lý thông tin báo Dân trí phản ánh', 'Nguyễn Bá Hảo', 'VB_QD', NULL, '', 0, 2, '2018-10-02 20:11:04'),
(2, 2, '2327/BTCTU', '2018-07-17 00:00:00', '2018-07-20', 'DV_SGD', 'Cán bộ đi nước ngoài', 'Lê Thành Trung', 'VB_CV', NULL, '', 0, 6, '2018-10-02 20:11:04');
